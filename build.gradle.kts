/*
 * Copyright 2025 niagaraforum. All Rights Reserved.
 */
...
niagaraSigning {
  aliases.set(listOf("DemoCertificate"))
  signingProfileFile.set(project.layout.projectDirectory.file("/home/admin/Niagara4.15/dev-signing-profile.xml"))
}
